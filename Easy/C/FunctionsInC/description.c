...
In this challenge, you will learn simple usage of functions in C. Functions are a bunch of statements glued together. 
...
Input will contain four integers: 'a', 'b', 'c' and 'd', one in each line.
